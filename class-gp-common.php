...
if( ! class_exists('GP_Common') ) :
    class GP_Common {
    	...
    	*/
        ...
        /*
    	*  check_is_author_login
    	*
    	*  Check whether user is login with another role
    	*  @type	function
    	*
    	*  @param	N/A
    	*  @return	return boolean. If user is login with auther role then true, else false.
    	*/
        public static function check_is_author_login(){
    	...
    	*
    	*  Sends an email when the author submit a post with draft status.
    	*  @type	function
    	*
    	...
    	*/
        public function send_admin_notify_email($post_id, $post){
            ...
            $message .= "Regards,<br> $blog_title<br>";
            $message .= site_url();        
            // Mail body end
