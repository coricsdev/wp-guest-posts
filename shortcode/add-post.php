    ...
    class GP_Add_Post extends GP_Common{
    	...
    	*/
        public static function gp_add_post($atts, $content = null) {
            ...
            $is_author_login = parent::check_is_author_login();
            if( true === $is_author_login){
                ob_start(); ?>
                <form method="post" id="add-post" name="add-post" class="add-post"  novalidate="novalidate">
                    ...
                    <?php
                        $post_types = parent::get_custom_post_type();
